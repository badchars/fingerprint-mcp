...
If you discover a security vulnerability in fingerprint-mcp, please report it responsibly.
...
This security policy covers the **fingerprint-mcp codebase only**. It does not cover:

- Third-party APIs that fingerprint-mcp connects to (Shodan, Censys, SecurityTrails, VirusTotal, etc.)
- Vulnerabilities in upstream dependencies (report those to the respective maintainers)
- Target servers being fingerprinted
